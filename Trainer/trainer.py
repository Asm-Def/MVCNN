...
class Trainer(object):
    def __init__(self, model, train_loader:DataLoader, val_loader:DataLoader, optimizer, loss_fn, model_name, log_dir, num_views=12, nclasses=40):
